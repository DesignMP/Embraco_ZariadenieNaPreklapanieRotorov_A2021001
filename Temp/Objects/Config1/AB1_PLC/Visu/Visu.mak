...
$(TEMP_PATH_Visu)/dis.PS2-Keyboard.vco: $(AS_PROJECT_PATH)/Physical/Config1/AB1_PLC/VC/PS2-Keyboard.dis $(PANEL_HW_SOURCE_Visu)
	$(VCHWPP) -f '$(PANEL_HW_SOURCE_Visu)' -o '$(subst .vco,.vci,$(TEMP_PATH_Visu)/dis.PS2-Keyboard.vco)' -n Visu -d Visu -pal '$(PALFILE_Visu)' -c '$(AS_CONFIGURATION)' -p '$(AS_PLC)' -ptemp '$(AS_TEMP_PLC)' -B 'D4.73' -L '' -hw '$(CPUHWC)' -warninglevel 2 -so $(VC_STATIC_OPTIONS_Visu) -sos $(VC_STATIC_OPTIONS_Shared) -keyboard '$(AS_PROJECT_PATH)/Physical/Config1/AB1_PLC/VC/PS2-Keyboard.dis' -fp '$(AS_VC_PATH)/Firmware/V4.72.5/SG4' -prj '$(AS_PROJECT_PATH)' -apj 'ZariadenieNaPreklapanieRotorov' -sfas -vcob '$(VCOBJECT_Visu)'
...
$(TEMP_PATH_Visu)/tpr.AlphaPad_QVGA.vco: $(AS_PROJECT_PATH)/Logical/HMI/Visu/TouchPads/AlphaPad_QVGA.tpr
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu)' $(VCCFLAGS_Visu) -prj 'D:/Projekty BER/Embraco_ZariadenieNaPreklapanieRotorov_A2021001/Logical/HMI/Visu' -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4725 -sfas
